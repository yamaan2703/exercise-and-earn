...
export const dummyProducts: ProductType[] = [
  ...
  },
  {
    ...
    stock: 54,
    description: "Breathable gym gloves to improve grip and protect hands.",
  },
  {
    id: "12",
    ...
    brand: "Peloton",
    price: 750,
    requiredCalories: 300,
    deliveryFee: 5,
    status: StatusProduct.ACTIVE,
    createdAt: "2025-12-12",
    stock: 43,
    description:
      "Smart cycling machine with adjustable resistance for cardio workouts.",
  },
  {
    id: "13",
    name: "Multivitamin",
    ...
    stock: 64,
    description: "Daily multivitamins to support overall health and immunity.",
  },
  {
    id: "14",
    name: "Pull-Up Bar",
    ...
    stock: 80,
    description:
      "Durable pull-up bar that fits most doors for strength training.",
  },
  {
    id: "15",
    name: "Pre-Workout",
    ...
    stock: 71,
    description:
      "Energy-boosting pre-workout powder for intense training sessions.",
  },
  {
    id: "16",
    name: "Rowing Machine",
    ...
    stock: 39,
    description:
      "Professional rowing machine for full-body cardio and endurance training.",
  },
  {
    id: "17",
    name: "Fish Oil",
    ...
    stock: 88,
    description:
      "Omega-3 rich fish oil to support heart, brain, and joint health.",
  },
  {
    id: "18",
    name: "Gym Bag",
    ...
    stock: 73,
    description:
      "Spacious gym bag with multiple compartments for all essentials.",
  },
  {
    id: "19",
    name: "Battle Rope",
    ...
    stock: 57,
    description:
      "Heavy-duty battle rope for strength, cardio, and endurance training.",
  },
  {
    id: "20",
    ...
    stock: 91,
    description: "Refreshing electrolyte drink to rehydrate during workouts.",
  },
  {
    id: "21",
    name: "Medicine Ball",
    ...
    stock: 69,
    description:
      "Weighted medicine ball for core strength and functional training.",
  },
  {
    id: "22",
    ...
    stock: 77,
    description:
      "Smart fitness tracker to monitor steps, sleep, and heart rate.",
  },
  {
    id: "23",
    ...
    stock: 82,
    description:
      "Glutamine powder to support recovery, gut health, and immunity.",
  },
  {
    id: "24",
    name: "Smith Machine",
    ...
    brand: "Force USA",
    price: 1200,
    requiredCalories: 400,
    deliveryFee: 5,
    status: StatusProduct.ACTIVE,
    createdAt: "2025-12-24",
    stock: 31,
    description: "All-in-one smith machine for professional strength training.",
  },
  {
    id: "25",
    name: "Shaker Bottle",
    ...
    stock: 120,
    description:
      "Durable shaker bottle with whisk ball for smooth protein shakes.",
  },
];
